...
user_dir               = sys.argv[2] #'.' 
algorithm_perf_sub_dir = sys.argv[3] #'trace_output_1213'
...
with open(algorithm_list) as fin:
    for line in fin:
        ...
        # filter failed case which out of memory and running time
        df_measure_list_old = df_measure_list_old[df_measure_list_old[2] >= -1]
        ...
        # filter problem size
        #df_measure_list_old = df_measure_list_old[df_measure_list_old[1] >= 100]
